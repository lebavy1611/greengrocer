...
class CreateOrderRequest extends ApiFormRequest
{
    ...
    public function messages()
    {
        ...
        return [
            'products.required'             => "Vui lòng mời bạn nhập vào sản phẩm",

            'full_name.required'             => "Vui lòng mời bạn nhập vào fullname",
            'full_name.string'               => "fullname phải là chuỗi kí ",
            'full_name.max'                  => "fullname không được quá 45 kí tự",

            'address.required'              => "Vui lòng mời bạn nhập vào địa chỉ",
            'address.string'                =>  "Địa chỉ phải là chuỗi kí ",
            'address.max'                   => "Địa  không được quá 255 kí tự",

            'phone.required'                => "Vui lòng mời bạn nhập vào số điện thoại",
            ...
            'payment_method_id.required'    => "Vui lòng mời bạn nhập vào hình thức thanh toán",
